...
import { CartWrapper, CartProduct, CartLeftSection, ReturnedProduct, CartRightSection, PhotoContainer, ListOfOptions, ButtonOrder, ButtonAdd, ButtonRemove, ImgOne, ImgTwo, Quantity, ListOfColors, QuantitySection, TitleWrapper, PhotoSection, Summary, ImgBtnLeft, ImgBtnRight } from './Styles'
        ...
        return (
            <section>
                <CartWrapper>
                    ...
                    <Summary>
                        <p>Tax 21%: </p><h2>{this.props.currentCurrency}{roundedTax}</h2>
                        <br />
                        <p>Quantity: </p><h2>{totalQuantity}</h2>
                        <br />
                        <p>Total: </p><h2>{this.props.currentCurrency}{roundedSum}</h2>
                        <br />
