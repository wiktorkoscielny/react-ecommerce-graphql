...
export const ListOfColors = styled.button`
    ...
    ${({ propsOption1, paramName, paramId }) => propsOption1 === paramName + paramId ? 'outline: 2px solid var(--light-green)' : null};
    ${({ propsOption2, paramName, paramId }) => propsOption2 === paramName + paramId ? 'outline: 2px solid var(--light-green)' : null};
    ${({ propsOption3, paramName, paramId }) => propsOption3 === paramName + paramId ? 'outline: 2px solid var(--light-green)' : null};
