...
export const ListOfOptions = styled.button`
    ...
    color: var(--text-dark);
    ${({ propsOption1, paramName, paramId }) => propsOption1 === paramName + paramId ? 'background: var(--text-dark) !important' : null};
    ${({ propsOption2, paramName, paramId }) => propsOption2 === paramName + paramId ? 'background: var(--text-dark) !important' : null};
    ${({ propsOption3, paramName, paramId }) => propsOption3 === paramName + paramId ? 'background: var(--text-dark) !important' : null};
...
export const ListOfColors = styled.button`
    ...
    ${({ propsOption1, paramName, paramId }) => propsOption1 === paramName + paramId ? 'outline: 2px solid var(--light-green) !important' : null};
    ${({ propsOption2, paramName, paramId }) => propsOption2 === paramName + paramId ? 'outline: 2px solid var(--light-green) !important' : null};
    ${({ propsOption3, paramName, paramId }) => propsOption3 === paramName + paramId ? 'outline: 2px solid var(--light-green) !important' : null};
